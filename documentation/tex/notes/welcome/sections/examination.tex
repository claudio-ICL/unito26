...
They are optional, and they are not added to the questionnaire:
what they buy is a lower pass mark.
...
\begin{equation}\label{eq.passMark}
 60 - a_{1} - a_{2} ,
\end{equation}
so the pass mark falls to 10 for a student who scores full marks on both.

...
The sweep cost of \eqref{eq.sweepCost} is the opposite:
it is a function of one configuration and is defined
whether or not the order it prices is ever submitted.
\end{remark}

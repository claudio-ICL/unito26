...
\begin{thm}\label{thm.lyapunov}
 ...
 Then the state $\decayedCounts$ has a stationary distribution with finite second moments,
...
$\mathbf{1}^{\transpose}$ is a positive left eigenvector,
and by Lemma \ref{lemma.perronFrobenius} an eigenvalue of a non-negative matrix with a
positive left eigenvector is its spectral radius.
Hence

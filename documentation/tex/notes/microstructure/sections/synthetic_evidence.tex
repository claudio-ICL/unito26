...
Every coefficient, every window and every goodness-of-fit figure is produced by
\texttt{notebooks/regressing-the-mid-on-the-imbalances.ipynb},
whose claims and seed blocks are fixed in advance in
\texttt{documentation/pre-registration-imbalance-regression.md};
none is reproduced here, so that none can go stale here.

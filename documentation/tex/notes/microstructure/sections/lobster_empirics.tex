...
\begin{assignment}\label{assignment.orderFlowImbalance}
 Take one ticker over a few hours of one or more trading days,
 ...
 \begin{enumerate}[label={\emph{\roman{*}}.}]
  \item Build the session from the message and orderbook files of
        ...
        reconcile the reconstructed book with the orderbook file LOBSTER supplies,
        and account for the discrepancies.

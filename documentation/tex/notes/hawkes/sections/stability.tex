...
\begin{center}
 \begin{tabular}{lcccccc}
  ...
  \midrule
  $\sum_e \branchingMatrix\subscriptee$ & $1.310$ & $1.310$ & $0.437$ & $0.437$ & $0.470$ & $0.470$ \\
  \bottomrule
 \end{tabular}
\end{center}
One market order begets $1.31$ direct events of one type or another,
against a limit order's $0.44$.
That single line is the replenishment asymmetry of the model expressed as a number:
aggression propagates, passive posting does not.
...
\begin{remark}[what $\branchingRatio$ is, and what it is not]\label{remark.rhoIsNot}
 ...
 there the column sums are $(1.31, 1.31, 0.44, 0.44, 0.47, 0.47)$,
 and at $\branchingRatio = 0.60$ the endogenous fraction is $0.576$ and
 $\bar C = 2.357$, against $1/(1-\branchingRatio) = 2.5$.

...
% \alert{A long horizon does not buy a forecast that exceeds the residual.}
...
% \alert{No statement of the form ``the order flow imbalance predicts continuation'' is made

...
% 4 min. remark.indexOrder. The row is excited and the column excites.
...
% \branchingRatio is neither the endogenous fraction nor 1 - 1/\bar C.
...
% At \totalRate/\decay well below one a study measures a process in which there is

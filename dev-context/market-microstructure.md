...
from this file — it records conclusions, not runs. What has been re-measured and carries
current numbers is the coverage sharpness, the column-sliced/grid-indexed imbalance
disagreement, the gap placement on the deep book, and the sweep coverage. The timing
*conditionals* are unaffected: whether a bottleneck exists is a property of the market, and
